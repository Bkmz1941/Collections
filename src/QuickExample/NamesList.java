...
public class NamesList {
    public static void main(String[] args) {
        ...
        names.add("Lee");
        names.add("Joe");
        System.out.printf("After adding elements: Size = %d, Elements = %s%n", names.size(), names);
        names.remove("Lee");
        System.out.printf("After removing 1 element: Size = %d, Elements = %s%n", names.size(), names);
        names.clear();
        System.out.printf("After cleaning all elements: Size = %d, Elements = %s%n", names.size(), names);
    }
}
